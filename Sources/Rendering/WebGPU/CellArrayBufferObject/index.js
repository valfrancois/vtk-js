...
import vtkBufferObject from 'vtk.js/Sources/Rendering/WebGPU/BufferObject';
...
// ----------------------------------------------------------------------------
// vtkWebGPUCellArrayBufferObject methods
// ----------------------------------------------------------------------------

function vtkWebGPUCellArrayBufferObject(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkWebGPUCellArrayBufferObject');
  ...
  publicAPI.createVBO = (cellArray, inRep, outRep, options) => {
    ...
    if (options.colors) {
      ...
      model.colorBO.setWebGPURenderWindow(model.WebGPURenderWindow);
    } else {
      model.colorBO = null;
    }
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkWebGPUCellArrayBufferObject(publicAPI, model);
}
